...
public:
  OdomToTF() : Node("odom_to_tf2") {
    ...
    child_frame_id_ =
        this->declare_parameter("child_frame_id", std::string(""));
    ...
    use_original_timestamp_ =
        this->declare_parameter("use_original_timestamp", false);
...
private:
  ...
  void odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg) const {
    ...
    if (not inverse_tf_) {
      ...
      tfs_.child_frame_id =
          child_frame_id_ != "" ? child_frame_id_ : msg->child_frame_id;
      ...
      tfs_.child_frame_id =
          child_frame_id_ != "" ? child_frame_id_ : msg->header.frame_id;
      tf2::Vector3 trans;
